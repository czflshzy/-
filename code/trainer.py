...
parser.add_argument('--model', default="convnext_tiny", type=str, help='resnet18 | mobilenet_v2 | resnet50 | convnext_base | regnet_x_400mf | convnext_tiny |')
...
# 在测试集上测试
path = r"F:\E\深度学习\bitmoji-faces-gender-recognition-master\checkpoints\convnext_tiny\1.0000.pth"
